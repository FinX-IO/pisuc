...
export default function PisucCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPisuc(initialValues.pisuc);
    setCurrency(initialValues.currency);
    setCountry(initialValues.country);
    setInstrumentClass(initialValues.instrumentClass);
    setInstrumentType(initialValues.instrumentType);
    setInstrumentDates(initialValues.instrumentDates);
    setInstrumentProps(initialValues.instrumentProps);
    setCreateDate(initialValues.createDate);
    setErrors({});
  };
  const validations = {
    pisuc: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Pisuc(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PisucCreateForm")}
      {...rest}
    >
      <TextField
        label="Pisuc"
